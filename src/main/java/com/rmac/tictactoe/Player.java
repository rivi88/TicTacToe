...
public class Player implements PlayerInterface {
    ...
    public Move move(int boardSize) {
        ...
        System.out.println(name + " select your ROW by keyboard " + getValidMoveRange(boardSize));
        int row;
        int col;
        try {
            row = scanner.nextInt();
            ...
            System.out.println(name + " select your COLUMN by keyboard " + getValidMoveRange(boardSize));
            col = scanner.nextInt();
    ...
    private String getValidMoveRange(int boardSize) {
        if (boardSize == 3) {
            return "0 or 1 or 2.";
        } else {
